...
namespace Vanilla.QM.Menu
{
    internal class Movement
    {
        ...
        internal static void InitMenu(QMNestedButton movementMenu)
        {
            ...
            var ignoreLimits = new QMToggleButton(movementMenu, 4, 0, "IgnoreLimt", delegate
            {
                TiltHeadHandler._ignoreLimit = true;
            }, delegate
            {
                TiltHeadHandler._ignoreLimit = false;
            },"Ingore For head Rotations");
