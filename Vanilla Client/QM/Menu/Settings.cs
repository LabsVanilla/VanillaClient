...
#pragma warning restore CS0626 // Method, operator, or accessor is marked external and has no attributes on it
        ...
        internal static void InitMenu(QMNestedButton settingsmenu)
        {
            ...
            var itemesp = new QMToggleButton(Pickups, 3, 0, "Item ESP", delegate
            {
                ...
                for (int i = 0; i < array.Length; i++)
                {
                    ...
                    System.Collections.Generic.List<Renderer> list = WorldWrapper.FindAllComponentsInGameObject<Renderer>(array[i].gameObject, includeInactive: false, searchParent: false);
            ...
            }, delegate
            {
                ...
                for (int k = 0; k < array3.Length; k++)
                {
                    ...
                    {
                        System.Collections.Generic.List<Renderer> list3 = WorldWrapper.FindAllComponentsInGameObject<Renderer>(array3[k].gameObject, includeInactive: false, searchParent: false);
            ...
            var swastika = new QMToggleButton(Pickups, 4, 0, "Swastika", delegate
            {
                SwastikaHandler.sovasticabool = true;
            }, delegate
            {
                SwastikaHandler.sovasticabool = false;
            },"Swastica");
