...
{
    internal class SelectedPlayer : VanillaModule
    {
        internal static void InitMenu(QMNestedButton Menu)
        {
            ...
            new QMToggleButton(Menu, 4, 0, "Orbit", delegate
            {

                ItemOrbitHandler.ItemOrbitToggle = true;
                ItemOrbitHandler.Recache();
                
            }, delegate
            {
                ItemOrbitHandler.ItemOrbitToggle = false;
                ItemOrbitHandler.Recache();
            }, "Orbit Items");
